...
import com.yosamaru.kassadin.demo.service.FeignSearchService;
...
/**
 * Feign调用kassadin-search接口示例
 * Created by macro on 2019/10/22.
 */
@Api(tags = "FeignSearchController", description = "Feign调用kassadin-search接口示例")
@RestController
