...
import com.yosamaru.kassadin.demo.dto.UmsAdminLoginParam;
import com.yosamaru.kassadin.demo.service.FeignAdminService;
import io.swagger.annotations.Api;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.bind.annotation.*;

/**
 * Feign调用kassadin-admin接口示例
 */
@Api(tags = "FeignAdminController", description = "Feign调用kassadin-admin接口示例")
@RestController
