...
public class VerificationCodeTokenGranter extends AbstractTokenGranter {
    ...
    protected VerificationCodeTokenGranter(AuthenticationManager authenticationManager, AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService, OAuth2RequestFactory requestFactory, String grantType) {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        Authentication userAuth = new VerificationCodeAuthenticationToken(username, password);
